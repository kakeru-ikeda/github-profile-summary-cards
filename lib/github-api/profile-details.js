...
const fetchPublicProfile = (username, token) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    return { publicRepos: res.data.public_repos, email: (_a = res.data.email) !== null && _a !== void 0 ? _a : '' };
});
function getProfileDetails(username, token) {
    return __awaiter(this, void 0, void 0, function* () {
        const [res, publicProfile] = yield Promise.all([
            fetcher(token, {
                login: username
            }),
